  ...
  render() {
    return (
      <div className="container">
        ...
        <Button id="clear" value="clear" display="AC" class="row-3 col-1-2" click={this.clearInput} />
        {/* <Button id="sign" value="+/-" display="±" class="row-3 col-2" /> */}
        <Button id="divide" value="/" display="÷" class="oper row-3 col-3" click={this.operInput} />
        ...
        <Button id="multiply" value="*" display="×" class="oper row-3 col-4" click={this.operInput} />
        ...
        <Button id="subtract" value="-" display="−" class="oper row-4 col-4" click={this.operInput} />
        ...
        <Button id="add" value="+" display="+" class="oper row-5 col-4" click={this.operInput} />
        ...
        <Button id="equals" value="=" display="=" class="oper row-6 col-4" click={this.calculate} />
      </div>
    );
  }
}
